"""
Django settings for EgoleBearingWebApp project.
...
ROOT_URLCONF = 'EgoleBearingWebApp.urls'
...
WSGI_APPLICATION = 'EgoleBearingWebApp.wsgi.application'
